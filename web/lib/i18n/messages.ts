...
const en = {
  ...
  "team.rosterCurrent": "Current roster",
  "team.rosterPast": "Roster history",
  ...
  "player.currentSplit": "Split in progress",
  "player.byPatch": "By patch",
  "common.gamesShort": "g",
...
const es: Record<MsgKey, string> = {
  ...
  "team.rosterCurrent": "Roster actual",
  "team.rosterPast": "Histórico de roster",
  ...
  "player.currentSplit": "Split en curso",
  "player.byPatch": "Por parche",
  "common.gamesShort": "p",
